        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-5">
              ...
              <span className="font-brand font-extrabold text-xl text-white tracking-tight" translate="no">HagerLand<span style={{fontSize:'0.5em',verticalAlign:'super',opacity:0.6,marginLeft:'1px',fontWeight:400}}>®</span></span>
            </Link>
