        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-5">
              ...
              <span className="font-bold text-xl text-white tracking-tight" translate="no">HagerLand<sup className="text-[0.72em] font-normal align-super opacity-80">&reg;</sup></span>
            </Link>
