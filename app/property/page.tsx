        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-xl">
              ...
              <Link href="/property/post" className="inline-flex items-center justify-center gap-2 bg-white/15 hover:bg-white/25 border border-white/30 text-white font-bold rounded-full px-6 py-3.5 text-sm transition-colors whitespace-nowrap">Post a listing →</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-24">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-8">
            <div className="flex items-center gap-3">
              {listingTypes.length > 0 && <FilterDropdown options={listingTypes} value={listingType} basePath="/property" paramName="type" allLabel="All types" />}
              {listingType && <Link href="/property" className="text-xs font-semibold text-green hover:underline">Clear</Link>}
            </div>
