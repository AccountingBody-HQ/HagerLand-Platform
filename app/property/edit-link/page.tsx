...
export default function EditLinkHousingPage() {
  return (
    <main className='min-h-screen bg-bg flex flex-col'>
      ...
      <section className='max-w-lg mx-auto px-4 sm:px-6 py-10 sm:py-16 w-full'>
        ...
        <form action='/api/property/resend-link' method='POST' className='bg-white border border-border rounded-2xl p-6 sm:p-8 flex flex-col gap-4'>
