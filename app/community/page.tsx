      ...
      <section className="relative overflow-hidden bg-green">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="max-w-3xl">
            <p className="inline-flex items-center gap-2.5 text-white/50 text-[11px] font-bold tracking-[0.18em] uppercase mb-8">ሃገር <span className="w-1 h-1 rounded-full bg-white/30" /> Homeland <span className="w-1 h-1 rounded-full bg-white/30" /> Community</p>
            ...
            <div className="flex flex-wrap items-center gap-x-8 gap-y-4 mb-10">
              {count != null && count > 0 && <div className="flex items-baseline gap-2"><span className="text-2xl font-bold text-white">{count.toLocaleString()}</span><span className="text-white/40 text-sm">organisations</span></div>}
            ...
            <Link href="/community/post" className="inline-flex items-center gap-2 bg-white text-green font-bold rounded-full px-7 py-3.5 text-sm hover:bg-green-soft transition-colors">List an organisation — free →</Link>
          </div>
        </div>
      </section>
