    ...
    <main className="min-h-screen bg-bg flex flex-col">
      ...
      <section className="max-w-2xl mx-auto px-4 sm:px-6 py-10 sm:py-16 flex-1 w-full">
        ...
        <div className="border border-border rounded-xl overflow-hidden mb-8">
          ...
          {listing.bedrooms && (
            <div className="flex items-center gap-4 px-5 py-4 border-b border-border">
              <span className="text-xs font-semibold uppercase tracking-wider text-muted w-24 shrink-0">Bedrooms</span>
              <span className="text-sm text-ink">{listing.bedrooms}</span>
            </div>
          )}
          {listing.location && (
            <div className="flex items-center gap-4 px-5 py-4 border-b border-border">
