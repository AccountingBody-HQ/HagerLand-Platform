...
export default async function VerifyClaimPage({
  ...
  try {
    ...
    await resend.emails.send({
      ...
      subject: `New verified claim — Housing: ${listingTitle}`,
      html: `<p><strong>${claim.claimant_name}</strong> (${claim.claimant_email}) has verified their claim for the Housing listing <strong>${listingTitle}</strong>.</p><p>Review and approve at <a href="https://www.hagerland.com/roodber8/claims">https://www.hagerland.com/roodber8/claims</a></p>`,
    })
  } catch (err) {
