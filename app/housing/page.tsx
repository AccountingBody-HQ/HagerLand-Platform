      ...
      <section className="relative overflow-hidden bg-green">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="max-w-3xl">
            ...
            <Link href="/housing/post" className="inline-flex items-center gap-2 bg-white text-green font-bold rounded-full px-7 py-3.5 text-sm hover:bg-green-soft transition-colors">Post a listing — free →</Link>
          </div>
        </div>
      </section>
