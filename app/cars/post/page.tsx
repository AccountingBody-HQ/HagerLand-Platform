    ...
    <main className="min-h-screen bg-bg">
      ...
      <section className="max-w-lg mx-auto px-4 sm:px-6 py-10 sm:py-16">
        <h1 className="text-2xl sm:text-3xl font-bold text-ink text-center mb-8">
          Post a car or service
        </h1>

        <form action={postCar} className="flex flex-col gap-4">
          <input
            type="text"
          ...
          <label className="text-sm font-medium text-ink">
            Listing type *
            <input name="listing_type" required placeholder="e.g. For Sale, Taxi/Private Hire, Garage/Repairs" className={inputStyle} />
          </label>
          ...
          <label className="text-sm font-medium text-ink">
            Price
            <input name="price" placeholder="e.g. £11,500 or From £2.50/mile" className={inputStyle} />
          </label>
