...
export const metadata = {
  title: 'Cars and taxi services',
  description: 'Buy or sell a car, find a private hire service, or a trusted driver in the Ethiopian community.',
}
        ...
        {listingTypes.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            {listingTypes.map((t) => (
              <Link
                key={t}
                href={`/cars?type=${encodeURIComponent(t)}`}
                className={`text-sm px-3.5 py-1.5 rounded-full border transition-colors ${
