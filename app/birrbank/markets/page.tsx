...
const SUB_PAGES = [
  { label:'Listed Equities', href:'/birrbank/markets/equities', desc:'Track all ESX-listed companies — prices, volumes, P/E ratios and dividends.', stat:'Live prices',
    icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg> },
  { label:'IPO Pipeline', href:'/birrbank/markets/ipo-pipeline', desc:'Prospectuses under ECMA review. Track upcoming listings before they open.', stat:'ECMA filings',
    icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/></svg> },
  { label:'Bonds & T-Bills', href:'/birrbank/markets/bonds', desc:'NBE Treasury bill auction results — yields, tenors and minimum investments.', stat:'NBE auctions',
    icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> },
  { label:'How to Invest', href:'/birrbank/markets/how-to-invest', desc:'Step-by-step guide to opening a brokerage account and buying ESX-listed shares.', stat:'Beginner guide',
    icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg> },
]
    ...
    <main className="bg-white flex-1">
      ...
      <section style={{ background:'#F4F5F3', padding:'96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-black uppercase tracking-widest mb-3" style={{ color:'#1C7C4C' }}>Capital markets</p>
      ...
      <section style={{ background:'#ffffff', padding:'96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-black uppercase tracking-widest mb-3" style={{ color:'#1C7C4C' }}>Listed equities</p>
          ...
          <div className="rounded-2xl overflow-hidden border border-slate-200" style={{ boxShadow:'0 4px 24px rgba(0,0,0,0.06)' }}>
            ...
            <div className="hidden sm:grid border-b border-slate-200"
              style={{ gridTemplateColumns:'80px 1fr 120px 110px 110px 110px 110px', padding:'12px 24px', background:'#F4F5F3' }}>
            ...
            <div className="flex items-center justify-between border-t border-slate-200" style={{ background:'#F4F5F3', padding:'14px 24px' }}>
              ...
              <Link href="/birrbank/markets/equities" className="text-xs font-bold" style={{ color:'#1C7C4C' }}>Full equities view →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background:'#F4F5F3', padding:'96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-black uppercase tracking-widest mb-3" style={{ color:'#1C7C4C' }}>IPO pipeline</p>
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <h2 className="font-bold text-slate-950"
              style={{ fontSize:'clamp(22px, 2.8vw, 32px)', letterSpacing:'-0.5px' }}>
          ...
          <div className="rounded-2xl overflow-hidden border border-slate-200" style={{ boxShadow:'0 2px 12px rgba(0,0,0,0.04)' }}>
            <div style={{ height:4, background:'linear-gradient(90deg, #1C7C4C, #155F3A)' }} />
            <div className="hidden sm:grid border-b border-slate-200"
              style={{ gridTemplateColumns:'1fr 120px 120px 120px 160px', padding:'12px 24px', background:'#F4F5F3' }}>
                ...
                <div key={ipo.id}>
                  <div className="hidden sm:grid items-center border-b border-slate-100 bg-white hover:bg-slate-50 transition-colors"
                    ...
                    <span className="text-xs font-bold rounded-full px-3 py-1 inline-flex w-fit items-center gap-1.5"
                      style={isReview ? { background:'#fef3c7', color:'#92400e' } : { background:'#F4F5F3', color:'#5B6472' }}>
                      <span className="w-1.5 h-1.5 rounded-full shrink-0" style={{ background: isReview ? '#f59e0b' : '#5B6472' }} />
            ...
            <div className="flex items-center justify-between border-t border-slate-200" style={{ background:'#F4F5F3', padding:'14px 24px' }}>
              ...
              <Link href="/birrbank/markets/ipo-pipeline" className="text-xs font-bold" style={{ color:'#1C7C4C' }}>See all {ipoCount}+ IPOs →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background:'#ffffff', padding:'96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-black uppercase tracking-widest mb-3" style={{ color:'#1C7C4C' }}>Fixed income</p>
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <h2 className="font-bold text-slate-950"
              style={{ fontSize:'clamp(22px, 2.8vw, 32px)', letterSpacing:'-0.5px' }}>
              NBE T-bill auction yields
            </h2>
            <Link href="/birrbank/markets/bonds" className="flex items-center gap-1 text-sm font-bold shrink-0" style={{ color:'#1C7C4C' }}>
      ...
      <section style={{ background:'#1C7C4C', padding:'96px 0', borderTop:'1px solid #155F3A' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-black uppercase tracking-widest mb-3 text-center" style={{ color:'#ffffff' }}>Data integrity</p>
            ...
            {[
              ...
              <div key={tag} className="rounded-2xl flex flex-col overflow-hidden"
                ...
                <div style={{ padding:'36px 32px' }} className="flex flex-col flex-1">
                  <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-6"
                    style={{ background:'linear-gradient(135deg, #E9F5EE, #E9F5EE)', border:'1px solid #BFE3CC' }}>
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                  </div>
      ...
      <section style={{ background:'#ffffff', padding:'96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-xs font-black uppercase tracking-widest mb-3" style={{ color:'#1C7C4C' }}>Market intelligence</p>
