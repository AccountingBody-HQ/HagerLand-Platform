...
export default async function BankingHubPage() {
  ...
  const SUB_PAGES = [
    { label:'Savings Rates',   href:'/birrbank/banking/savings-rates',  desc:'Compare savings and fixed deposit rates across all commercial banks.', stat:'Updated daily',
      icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> },
    { label:'Loan Comparison',  href:'/birrbank/banking/loans',          desc:'Personal, car, home and business loan rates with EMI calculator.',   stat:'All loan types',
      icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg> },
    { label:'FX Rates',         href:'/birrbank/banking/fx-rates',       desc:'Official NBE indicative rates vs per-bank buying and selling rates.', stat:`${fxCurrencyCount} currencies`,
      icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg> },
    { label:'Mobile Money',     href:'/birrbank/banking/mobile-money',   desc:'TeleBirr, HelloCash, Amole and CBEBirr — compare all payment operators.', stat:`${paymentCount} operators`,
      icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg> },
    { label:'Microfinance',     href:'/birrbank/banking/microfinance',   desc:'Micro-loans, rural finance and SME credit from licensed MFIs.',     stat:`${mfiCount} MFIs`,
      icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> },
    { label:'Money Transfer',   href:'/birrbank/banking/money-transfer', desc:'Compare diaspora remittance fees and transfer speed across agencies.', stat:`${transferCount} agencies`,
      icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1C7C4C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg> },
  ]
    ...
    <main className="bg-white flex-1">
      ...
      <section style={{ background: '#F4F5F3', padding: '96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-black uppercase tracking-widest mb-3" style={{ color: '#1C7C4C' }}>Explore</p>
      ...
      <section style={{ background: '#ffffff', padding: '96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            ...
            <Link href="/birrbank/banking/savings-rates" className="flex items-center gap-1 text-sm font-bold shrink-0" style={{ color: '#1C7C4C' }}>
              See all {bankCount} banks <ChevronRight size={13} />
            </Link>
          </div>
          <div className="rounded-2xl overflow-hidden border border-slate-200" style={{ boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
            <div style={{ height: 4, background: 'linear-gradient(90deg, #1C7C4C, #155F3A)' }} />
            <div className="hidden sm:grid grid-cols-12 border-b border-slate-100" style={{ padding: '12px 24px', background: '#F4F5F3' }}>
              ...
              <div key={r.rank}
                ...
                <div className="col-span-1">
                  <div className="w-7 h-7 rounded-lg flex items-center justify-center text-xs font-black"
                    style={r.rank===1 ? { background:'#1C7C4C', color:'#fff' } : { background:'#F4F5F3', color:'#5B6472' }}>
            ...
            <div className="flex items-center justify-between border-t border-slate-200" style={{ background:'#F4F5F3', padding:'14px 24px' }}>
              ...
              <Link href="/birrbank/banking/savings-rates" className="text-xs font-bold" style={{ color:'#1C7C4C' }}>Full comparison →</Link>
            </div>
          </div>
      ...
      <section style={{ background: '#F4F5F3', padding: '96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            ...
            <Link href="/birrbank/banking/fx-rates" className="flex items-center gap-1 text-sm font-bold shrink-0" style={{ color:'#1C7C4C' }}>
                  ...
                  <div style={{ padding: '28px 24px' }}>
                    <div className="flex items-center justify-between mb-5">
                      <span className="inline-flex items-center rounded-lg font-black text-white"
                        style={{ background:'#1C7C4C', padding:'5px 14px', fontSize:13, letterSpacing:1 }}>{fx.currency}</span>
      ...
      <section style={{ background: '#1C7C4C', padding: '96px 0', borderTop: '1px solid #155F3A' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-black uppercase tracking-widest text-center mb-4" style={{ color: '#ffffff' }}>Why BirrBank</p>
      ...
      <section style={{ background:'#ffffff', padding:'96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-xs font-black uppercase tracking-widest mb-4" style={{ color: '#1C7C4C' }}>Stay informed</p>
