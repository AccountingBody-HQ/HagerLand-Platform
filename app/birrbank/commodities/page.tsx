  ...
  return (
    <main className="bg-white flex-1">
      ...
      <section style={{ background:'#ffffff', padding:'96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <p className="text-xs font-black uppercase tracking-widest mb-2" style={{ color:'#1C7C4C' }}>Coffee</p>
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <Link href="/birrbank/commodities/coffee" className="flex items-center gap-1 text-sm font-bold" style={{ color:'#1C7C4C' }}>
          ...
          <div className="rounded-2xl overflow-hidden border border-slate-200" style={{ boxShadow:'0 4px 24px rgba(0,0,0,0.06)' }}>
            ...
            <div className="hidden sm:grid border-b border-slate-200"
              style={{ gridTemplateColumns:'120px 1fr 120px 140px 110px 100px', padding:'12px 24px', background:'#F4F5F3' }}>
              ...
              return (
                <div key={c.id} className={'border-b border-slate-100 transition-colors ' + (i===0 ? 'bg-amber-50' : 'bg-white hover:bg-slate-50')}>
                  <div className="hidden sm:grid items-center"
                    ...
                    <span className="font-mono font-bold text-xs rounded-lg px-2 py-1 w-fit" style={{ background:'#E9F5EE', color:'#1C7C4C' }}>{c.commodity_code}</span>
                  ...
                  <div className="sm:hidden flex items-center gap-3" style={{ padding:'14px 16px' }}>
                    <span className="font-mono font-bold text-xs rounded-lg px-2 py-1 shrink-0" style={{ background:'#E9F5EE', color:'#1C7C4C' }}>{c.commodity_code}</span>
            ...
            <div className="flex items-center justify-between border-t border-slate-200" style={{ background:'#F4F5F3', padding:'14px 24px' }}>
              ...
              <Link href="/birrbank/commodities/coffee" className="text-xs font-bold" style={{ color:'#1C7C4C' }}>All coffee grades →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background:'#F4F5F3', padding:'96px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <p className="text-xs font-black uppercase tracking-widest mb-2" style={{ color:'#1C7C4C' }}>Sesame and grains</p>
            <h2 className="font-bold text-slate-950"
              style={{ fontSize:'clamp(22px, 2.8vw, 32px)', letterSpacing:'-0.5px' }}>
                  ...
                  <div key={c.id} className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-green/40 hover:shadow-md transition-all">
                    ...
                    <div style={{ padding:'24px' }}>
                      <div className="flex items-center justify-between mb-3">
                        <span className="font-mono font-bold text-xs rounded-lg px-2 py-1" style={{ background:'#E9F5EE', color:'#1C7C4C' }}>{c.commodity_code}</span>
      ...
      <section style={{ background:'#1C7C4C', padding:'96px 0', borderTop:'1px solid #155F3A' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-black uppercase tracking-widest mb-3 text-center" style={{ color:'#ffffff' }}>Why BirrBank</p>
