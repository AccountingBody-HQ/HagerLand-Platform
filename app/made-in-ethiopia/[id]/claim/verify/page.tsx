...
export default async function VerifyClaimPage({
  ...
  try {
    ...
    await resend.emails.send({
      ...
      subject: `New verified claim — Made in Ethiopia: ${listingTitle}`,
      html: `<p><strong>${claim.claimant_name}</strong> (${claim.claimant_email}) has verified their claim for the Made in Ethiopia listing <strong>${listingTitle}</strong>.</p><p>Review and approve at <a href="https://www.hagerland.com/roodber8/claims">https://www.hagerland.com/roodber8/claims</a></p>`,
    })
  } catch (err) {
    ...
    <main className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="text-center max-w-md">
          ...
          <Link
            href={`/made-in-ethiopia/${params.id}`}
    ...
    <main className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="text-center max-w-md">
          ...
          <Link
            href={`/made-in-ethiopia/${id}/claim`}
            className="inline-block bg-green hover:bg-green-dark text-white font-semibold rounded-full px-6 py-2.5 transition-colors"
          >
            Try again
          </Link>
