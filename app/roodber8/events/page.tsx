  ...
  return (
    <div style={{ padding: 32, maxWidth: 1000, margin: '0 auto' }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 800, color: C.text, margin: '8px 0 4px' }}>Events</h1>
            ...
            {pending.map((item, idx) => (
              <div key={item.id} style={{ padding: '14px 20px', borderBottom: idx < pending.length - 1 ? `1px solid ${C.border}` : 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16 }}>
                ...
                <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                  <form action={approveListing.bind(null, 'events', item.id)}>
                  ...
                  <form action={rejectListing.bind(null, 'events', item.id)}>
