            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {business.is_verified && (
                  <span className="inline-flex items-center gap-1.5 h-6 bg-gold-soft text-gold text-[11px] font-semibold px-2.5 rounded-full">
                ...
                {business.sic_description && (
                  <span className="inline-flex items-center gap-1.5 h-6 bg-white/15 border border-white/20 text-white/90 text-[11px] font-semibold px-2.5 rounded-full">
                    {business.sic_description}
                  </span>
                )}
              </div>
